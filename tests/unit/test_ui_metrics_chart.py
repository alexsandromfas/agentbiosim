...
def test_metrics_chart_tracks_count_and_single_group_intelligence_series_per_label():
    ...
    assert f"label_{label_id}_count" in keys
    ...
    assert ui._metrics_history[-1][f"label_{label_id}_count"] == 2.0
